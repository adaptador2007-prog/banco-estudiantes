...
return { ok: true, mensaje: `Hola bienvenido al sistema bancario de ${nombre}, retiro aprobado`, saldo: saldoInicial -
monto };
} else {
return { ok: false, mensaje: `Hola bienvenido al sistema bancario de ${nombre}, no tienes suficiente saldo`, saldo:
saldoInicial };
